...
var t1=acc.define_array(new Array(1000).fill(0.8));
var t2=acc.define_array(new Array(1000).fill(123.8));
...
init_time=now();
var A=  new Array(1000).fill(0.8);
var B = new Array(1000).fill(123.8);
var C = [];
var D = [];
for (var k = 0; k < 200; k++) {
